...
public class BaseController {
  ...
  public String getBodyStringParam(RoutingContext context, String paramName)
   ...
   */
  public String getBodyStringParam(RoutingContext context, String paramName, String defaultValue)
      throws RuntimeException {
  ...
  public Integer getBodyIntegerParam(RoutingContext context, String paramName)
      throws RuntimeException {
   ...
   * @throws RuntimeException - exception thrown if parse or read errors
   */
  public Integer getBodyIntegerParam(RoutingContext context, String paramName, Integer defaultValue)
      throws RuntimeException {
    return defaultValue != null
   ...
   * @throws RuntimeException - exception thrown if parse or read errors
   */
  public Long getBodyLongParam(RoutingContext context, String paramName, Long defaultValue)
      throws RuntimeException {
    return defaultValue != null
  ...
  public Boolean getBodyBooleanParam(RoutingContext context, String paramName)
      throws RuntimeException {
   ...
   * @throws RuntimeException - exception thrown if parse or read errors
   */
  public Boolean getBodyBooleanParam(RoutingContext context, String paramName, Boolean defaultValue)
      throws RuntimeException {
    return defaultValue != null
  ...
  public JsonObject getBodyJsonObjectParam(RoutingContext context, String paramName)
      throws RuntimeException {
   ...
   * @throws RuntimeException - exception thrown if parse or read errors
   */
  public JsonObject getBodyJsonObjectParam(
      RoutingContext context, String paramName, JsonObject defaultValue) throws RuntimeException {
    return defaultValue != null
        ? context.getBodyAsJson().getJsonObject(paramName, defaultValue)
        : context.getBodyAsJson().getJsonObject(paramName);
  }

  public JsonArray getBodyJsonArrayParam(RoutingContext context, String paramName)
      throws RuntimeException {
   ...
   * @throws RuntimeException - exception thrown if parse or read errors
   */
  public JsonArray getBodyJsonArrayParam(
      RoutingContext context, String paramName, JsonArray defaultValue) throws RuntimeException {
    return defaultValue != null
